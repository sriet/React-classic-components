...
const useStyles = makeStyles({
  ...
  tableHead: { "& th, td": { color: "#828282", padding:0, paddingTop: "12px", paddingBottom: '4px' }},
  tableBody: { "& td, & th": { border: 0, padding:0, paddingTop: "8px", paddingBottom: "0px", },},
  tableFoot: { 
    "& td, & th": { border: 0, padding:0, paddingTop: "8px", paddingBottom: "0px", },
                ...
                <Grid container>
                  ...
                  >
                    ...
                    <StockInput
                      ...
                      value={moment(props.dates.value).format("MM/DD/YY")}
                    />
                  </Grid>
                </Grid>
              </Grid>
                ...
                <Grid container spacing={1}>
                  {props.rules.map((item, index)=>(
                    <Grid item xs={'auto'} key={index}>
                        <Typography bgcolor="#828282" color='#fff' padding={'4px 8px'} borderRadius='3px'>{item}</Typography>
                    </Grid>
                  ))}
                  <Grid item xs={'auto'} >
                    <AddIcon sx={{fontSize:"18px", padding:'7px', border:'1px dashed gray'}}/>
                  </Grid>
                </Grid>
              </Grid>
            </Grid>
